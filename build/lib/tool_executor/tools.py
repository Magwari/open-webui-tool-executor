...
Function signatures match OpenWebUI builtin.py so that LLM-generated
...
# Signatures match OpenWebUI builtin.py.
...
TOOL_HANDLERS: dict[str, Callable] = {
    ...
    'replace_memory_content': _wrap_async(openwebui_client.replace_memory_content),
    ...
    'view_knowledge_file': _wrap_async(openwebui_client.view_knowledge_file),
    'query_knowledge_files': _wrap_async(openwebui_client.query_knowledge_files),
    'query_knowledge_bases': _wrap_async(openwebui_client.query_knowledge_bases),
    'list_knowledge': _wrap_async(openwebui_client.list_knowledge),
    ...
    'edit_image': _wrap_async(openwebui_client.edit_image),
    ...
    'write_note': _wrap_async(openwebui_client.write_note),
    'replace_note_content': _wrap_async(openwebui_client.replace_note_content),
    ...
    'search_channel_messages': _wrap_async(openwebui_client.search_channel_messages),
    'view_channel_message': _wrap_async(openwebui_client.view_channel_message),
    'view_channel_thread': _wrap_async(openwebui_client.view_channel_thread),
    ...
    'update_calendar_event': _wrap_async(openwebui_client.update_calendar_event),
    ...
    'update_automation': _wrap_async(openwebui_client.update_automation),
